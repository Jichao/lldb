...
#ifndef liblldb_ThreadPlanGotoUser_h_
#define liblldb_ThreadPlanGotoUser_h_
...
namespace lldb_private {
    ...
    class ThreadPlanGotoUser : public ThreadPlan {
    public:
        ThreadPlanGotoUser(Thread &thread, bool step_over, bool stop_others,
                                  Vote stop_vote, Vote run_vote);
        
        ~ThreadPlanGotoUser() override;
...
#endif // liblldb_ThreadPlanGotoUser_h_
